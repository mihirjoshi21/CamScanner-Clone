...
public class CameraBasicFragment extends Fragment
    ...
    public static CameraBasicFragment newInstance(String imagePath) {
        CameraBasicFragment cameraBasicFragment = new CameraBasicFragment();
        Bundle bundle = new Bundle();
        bundle.putString(MediaStore.EXTRA_OUTPUT, imagePath);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mImagePath = getArguments().getString(MediaStore.EXTRA_OUTPUT);
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    final Activity activity = getActivity();
                    if (activity != null) {
                        activity.runOnUiThread(() -> MyBus.getInstance().post(mFile));
                    }
                }
            };
